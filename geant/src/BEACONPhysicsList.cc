...
BEACONPhysicsList::BEACONPhysicsList()
{
    cout<<"constructing Physics List"<<endl;
...
void BEACONPhysicsList::ConstructParticle()
{
    cout<<"constructing Particle"<<endl;
...
void BEACONPhysicsList::ConstructIons()
{
  }

void BEACONPhysicsList::ConstructBosons()
{
	// gamma
    cout<<"constructing Bosons"<<endl;

	G4Gamma::GammaDefinition();
}

void BEACONPhysicsList::ConstructLeptons()
{
	// leptons
	//  e+/-
    cout<<"constructing Leptons"<<endl;
...
void BEACONPhysicsList::ConstructMesons()
{
	//  mesons
	//    light mesons
    cout<<"constructing Mesons"<<endl;
...
void BEACONPhysicsList::ConstructBaryons()
{
	//  baryons
    cout<<"constructing Baryons"<<endl;
...
void BEACONPhysicsList::ConstructProcess()
{
   // Define transportation process
    cout<<"constructing Processes"<<endl;
...
void BEACONPhysicsList::ConstructEM()
{
    cout<<"constructing EM"<<endl;
...
void BEACONPhysicsList::ConstructGeneral()
{
	// Add Decay Process
...
void BEACONPhysicsList::AddStepMax()
{
...
void BEACONPhysicsList::SetCuts()
{
